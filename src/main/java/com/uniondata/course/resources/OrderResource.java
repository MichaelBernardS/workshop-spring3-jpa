...
import com.uniondata.course.services.OrderService;
...
public class OrderResource {
	...
	public ResponseEntity<List<Order>> findAll() { // Método que é um endpoint para acessar a lista de usuários;
	...
	public ResponseEntity<Order> findById(@PathVariable Long id) { // Retornar apenas um usuário, recebendo o param de url dentro do endpoint do controlador Rest; @PathVariable serve para o Spring aceitar esse id e considerá-lo como url;
